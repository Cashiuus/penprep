...
# ===============[ MySQL server ]===================
echo -e "${YELLOW}[INFO]${RESET} During MySQL installation, you must enter a root password."
pause
$SUDO apt-get -y install mysql-server


# Run a hardening script to secure it
echo -e "${YELLOW}[INFO]${RESET} Running MySQL hardening script, enter root password and follow the prompts."
pause
...
# FUTURE: Delete old PHP5 first
#echo -e "[DEBUG] Need to delete the following packages before continuing"
