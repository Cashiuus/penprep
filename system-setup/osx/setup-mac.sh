...
#
#
#   Apps [Optionally] Needed in this setup (to set some defaults for them):
#       - iCal
...
# NOTE: current user is in: USER=john, LOGNAME=john
...
# Disabled this spring loading because didn't like the behavior
...
# Set the icon size of Dock items to 32 pixels (mthsbe uses 36)
...
# Specify speed of the animation for hiding/showing Dock
...
# I may have disabled this because I'd prefer the "pick up where you left off" approach
...
# Complete themes bundle: https://github.com/mbadolato/iTerm2-Color-Schemes/zipball/master
open "${ITERM_THEME}"
...
#plistbuddy -c "Print :orderedItems" ~/Library/Preferences/com.apple.spotlight.plist
