...
#
# Author:   Cashiuus
# Created:  17-Jan-2016 - - - - - - (Revised: 09-May-2017)
#
...
echo -e "${GREEN}[*]${RESET} Set a password for this new user..."
...
[[ $? -eq 0 ]] && echo -e "${GREEN}[*]${RESET} You must logout and/or restart for it to take effect."
