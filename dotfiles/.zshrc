...
if [[ "$color_prompt" = yes ]]; then
    # My old .bashrc version I used - color codes don't work
    #PROMPT="${debian_chroot:+($debian_chroot)}\[\033[31m\]\u\[\033[m\]@\[\033[32m\]\h:\[\033[36m\]\w\[\033[m\]\$ "
    # The original OEM kali 2-line prompt
